...
const AddAddress = () => {
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-2xl text-gray-500'>Add Shipping <span className='font-semibold text-primary'>Address</span> </p>
        <div className='flex flex-col-reverse md:flex-row justiffy-between mt-10'>
